function fn_analysis_position_versus_time2

rel_stats= (LICK2D.ROILick2DPSTHStatsSpikes & 'psth_regular_odd_vs_even_corr>0.5') - IMG.Mesoscope;
% key.subject_id = 464725;
% rel_stats=rel_stats & key;
% ROILick2DmapStatsSpikes3bins
rel_stats2=LICK2D.ROILick2DmapStatsSpikes3bins  & rel_stats;

% psth_time = fetch1(LICK2D.ROILick2DPSTH & rel_stats, 'psth_time','LIMIT 1');
