...
rel_reaction_time  = (TRACKING.VideoNthLickTrial*EXP2.SessionTrialUniqueIDCorrect & key ) & (EXP2.TrialLickPortPositionRescale &  key) -TRACKING.VideoGroomingTrial & 'lick_touch_number=1';
...
Reaction_Time = fetchn( rel_reaction_time,'lick_time_onset','ORDER BY trial_uid_correct');


for i_tr=1:1:numel(B)
