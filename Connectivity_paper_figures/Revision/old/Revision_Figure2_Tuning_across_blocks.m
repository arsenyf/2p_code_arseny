...
for i_b=1:1:number_blocks
    ...
    if i_b==1
        rel_current_temporal = (LICK2D.ROILick2DPSTHBlockStatsSpikes & sprintf('psth_first_odd_vs_even_corr>=%.2f',psth_regular_odd_vs_even_corr)) & (LICK2D.ROILick2DPSTHSpikesModulation & sprintf('psth_first_modulation>=%.2f',psth_regular_modulation_threshold)) & rel_roi;
        rel_current_positional = LICK2D.ROILick2DmapSpikes3binsModulation & sprintf('lickmap_fr_first_modulation>=%.2f',lickmap_fr_regular_modulation_threshold) & (LICK2D.ROILick2DmapStatsSpikes3binsShort & sprintf('lickmap_regular_odd_vs_even_corr>=%.2f',lickmap_regular_odd_vs_even_corr_threshold)) & rel_roi;
    elseif i_b==2
        rel_current_temporal = (LICK2D.ROILick2DPSTHBlockStatsSpikes & sprintf('psth_begin_odd_vs_even_corr>=%.2f',psth_regular_odd_vs_even_corr)) & (LICK2D.ROILick2DPSTHSpikesModulation & sprintf('psth_begin_modulation>=%.2f',psth_regular_modulation_threshold))& rel_roi;
        rel_current_positional = LICK2D.ROILick2DmapSpikes3binsModulation & sprintf('lickmap_fr_begin_modulation>=%.2f',lickmap_fr_regular_modulation_threshold) & (LICK2D.ROILick2DmapStatsSpikes3binsShort & sprintf('lickmap_regular_odd_vs_even_corr>=%.2f',lickmap_regular_odd_vs_even_corr_threshold)) & rel_roi;
    elseif i_b==3
        rel_current_temporal = (LICK2D.ROILick2DPSTHBlockStatsSpikes & sprintf('psth_mid_odd_vs_even_corr>=%.2f',psth_regular_odd_vs_even_corr)) & (LICK2D.ROILick2DPSTHSpikesModulation & sprintf('psth_mid_modulation>=%.2f',psth_regular_modulation_threshold)) & rel_roi;
        rel_current_positional = LICK2D.ROILick2DmapSpikes3binsModulation & sprintf('lickmap_fr_mid_modulation>=%.2f',lickmap_fr_regular_modulation_threshold) &  (LICK2D.ROILick2DmapStatsSpikes3binsShort & sprintf('lickmap_regular_odd_vs_even_corr>=%.2f',lickmap_regular_odd_vs_even_corr_threshold)) & rel_roi;
    elseif i_b==4
        rel_current_temporal = (LICK2D.ROILick2DPSTHBlockStatsSpikes & sprintf('psth_end_odd_vs_even_corr>=%.2f',psth_regular_odd_vs_even_corr)) & (LICK2D.ROILick2DPSTHSpikesModulation & sprintf('psth_end_modulation>=%.2f',psth_regular_modulation_threshold)) & rel_roi;
        rel_current_positional = LICK2D.ROILick2DmapSpikes3binsModulation & sprintf('lickmap_fr_end_modulation>=%.2f',lickmap_fr_regular_modulation_threshold) & (LICK2D.ROILick2DmapStatsSpikes3binsShort & sprintf('lickmap_regular_odd_vs_even_corr>=%.2f',lickmap_regular_odd_vs_even_corr_threshold)) & rel_roi;
    end
    ...
    for i_k=1:1:numel(keys)
        ...
        temp_rel_temporal= rel_current_temporal  & keys(i_k);
        temporal_count(i_k)=temp_rel_temporal.count;
        
        temp_rel_pos=rel_current_positional & keys(i_k);
