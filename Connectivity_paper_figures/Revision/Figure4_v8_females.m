...
filename=[sprintf('Figure4_v8_females')];
...
rel_data = STIMANAL.InfluenceVsCorrTraceSpont*EXP2.SessionID  & 'num_pairs>=0' & 'num_targets>=0' ...
    &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' ) & (LAB.Subject & 'sex="F"');
...
PLOT_Network_Degree_vs_tuning_final_females()


Plot_in_out_degree_and_bidirectional_connectivity_females()

PLOT_Network_Degree_vs_tuning_similarity_to_connected_neurons_f()
