...
subplot(3,2,1)
plot(tuning2target_stability_all,tuning2tongue_stability_all,'.k')
xlabel('Tuning stability based on target position')
ylabel('Tuning stability based on tongue position')
