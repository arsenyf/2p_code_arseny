function Plot_in_out_degree_and_bidirectional_connectivity_males()
% close;
...
filename = 'In_out_degree_and_bidirectional_connectivity_males';
DefaultFontSize =15;
...
rel1= STIMANAL.ConnectivityBetweenDirectlyStimulatedOnlyOverconnected   &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' )  & (LAB.Subject & 'sex="M"');
