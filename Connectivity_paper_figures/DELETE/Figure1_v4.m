...
hold on;
fn_video_plot_projections_ZY (key_tongue_trial1, Zpix2mm, Xpix2mm, key_tongue_session)

% Lick trial trajectory X-Y2
axes('position',[position_lick_x2(2),position_lick_y2(1), panel_lick_width2, panel_lick_height2])
hold on;
fn_video_plot_projections_XY (key_tongue_trial1, Zpix2mm, Xpix2mm, key_tongue_session)
...
hold on;
fn_video_plot_projections_ZY (key_tongue_trial2, Zpix2mm, Xpix2mm, key_tongue_session)


% Lick trial trajectory X-Y2
axes('position',[position_lick_x2(2),position_lick_y2(2), panel_lick_width2, panel_lick_height2])
hold on;
fn_video_plot_projections_XY (key_tongue_trial2, Zpix2mm, Xpix2mm, key_tongue_session)
...
a=histogram(psth_time(idx_max_time),time_bins);
y =100*a.BinCounts/numel(idx_max_time);
...
idx_positional = [D.information_per_spike_regular]>=0.2 & [D.psth_position_concat_regular_odd_even_corr]>=0.5;
