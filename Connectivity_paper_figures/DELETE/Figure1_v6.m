...
D_tuned.field_size_without_baseline_regular=fetchn(rel_stats2 & 'lickmap_regular_odd_vs_even_corr>=0.75', 'field_size_without_baseline_regular','ORDER BY roi_number_uid');
...
[hhh2,edges]=histcounts([D_tuned.field_size_without_baseline_regular],linspace(0,100,10));
