function fn_analysis_position_versus_time3
...
rel_stats= (LICK2D.ROILick2DPSTHStatsSpikesLongerInterval & 'psth_regular_odd_vs_even_corr>0.5') & rel_roi;
% rel_stats= (LICK2D.ROILick2DPSTHStatsSpikesLongerInterval ) & rel_roi;
...
peaktime_psth = fetchn(rel_stats, 'peaktime_psth_regular','ORDER BY roi_number');
...
idx_positional = information_per_spike_regular>=0.15 & psth_position_concat_regular_odd_even_corr>0.5;
