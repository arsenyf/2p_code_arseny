function Supplementary_Figure_5_prepost_synaptic_correlation()
dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Connectivity_paper_figures\plots\'];

filename=[sprintf('Supplementary_Figure_5__prepost_synaptic_correlation')];
clf;
...
set(gca,'FontSize',24);
xlabel(sprintf('  Correlation, r\n (Target neuron, Causally-connected neuron)'),'FontSize',24);
