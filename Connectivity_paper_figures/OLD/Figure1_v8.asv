...
%% Eucledian
axes('position',[position_x5(2)+0.0075,position_y5(2), panel_width5, panel_height5])
% all sessions
...
axes('position',[position_x5(3)+0.0075,position_y5(2), panel_width5, panel_height5])
hold on
lineProps.col={[1 0 0]};
lineProps.style='-';
lineProps.width=0.25;
