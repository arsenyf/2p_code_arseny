function Plot_in_out_degree_and_bidirectional_connectivity_females()
% close;
...
filename = 'In_out_degree_and_bidirectional_connectivity_females';
DefaultFontSize =15;
...
rel1= STIMANAL.ConnectivityBetweenDirectlyStimulatedOnlyOverconnected   &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' )  & (LAB.Subject & 'sex="F"');
