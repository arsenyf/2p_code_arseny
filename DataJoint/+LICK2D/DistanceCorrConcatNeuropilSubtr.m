...
classdef DistanceCorrConcatNeuropilSubtr < dj.Computed
    properties
                keySource = (EXP2.SessionEpoch  & IMG.ROI & LICK2D.ROILick2Dmap3binsNeuropilsubtract - IMG.Mesoscope) & IMG.Volumetric ;
    end
        ...
        function makeTuples(self, key)
           ...
           if mesoscope_flag==1
            ...
            for i_c = 1:1:numel(psth_position_concat_regular_odd_even_corr)
                ...
                rel_data = LICK2D.ROILick2Dmap3binsNeuropilsubtract & rel_roi & key;
