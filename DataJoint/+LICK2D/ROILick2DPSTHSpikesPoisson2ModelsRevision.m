...
classdef ROILick2DPSTHSpikesPoisson2ModelsRevision < dj.Imported
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
           flag_electric_video = 1; %detect licks with electric contact or video (if available) 1 - electric, 2 - video
            ...
            fn_computer_Lick2DPSTH_Poisson2ModelsRevision(key,self, rel_data,fr_interval, fr_interval_limit,flag_electric_video, time_resample_bin);
