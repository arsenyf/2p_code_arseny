    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i_c = 1:1:numel(p_value_threshold)
                ...
                rel_roi = IMG.ROI & (IMG.ROIGood-IMG.ROIBad) & key & (LICK2D.ROILick2DmapSpikes3binsPvalue & sprintf('psth_position_concat_regular_odd_even_corr_pval<=%.2f',p_value_threshold(i_c)));
