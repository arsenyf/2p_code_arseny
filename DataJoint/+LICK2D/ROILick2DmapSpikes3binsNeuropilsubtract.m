%{
# Positional 2D tuning of a neuron (firing-rate map averaged across the entire trial duration) with each pixel corresponding to neuronal response to a specific lick-port position in 2D, after subtracting neuropil
-> EXP2.SessionEpoch
-> IMG.ROI
number_of_bins                          : int   #
---
...
classdef ROILick2DmapSpikes3binsNeuropilsubtract < dj.Computed
    properties
...
keySource = ((EXP2.SessionEpoch*IMG.FOV) & IMG.ROI & IMG.ROIdeltaFNeuropilSubtr  & EXP2.TrialLickPort & 'session_epoch_type="behav_only"' & EXP2.TrialLickBlock) - IMG.Mesoscope;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
           flag_electric_video = 1; %detect licks with electric contact or video (if available) 1 - electric, 2 - video
            ...
            fn_compute_Lick2D_map_and_selectivity2_3bins_neuropil_subtract (key,self, rel_data, fr_interval, fr_interval_limit, flag_electric_video);
