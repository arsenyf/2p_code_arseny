...
classdef ROILick2DPSTHSpikesGLM2 < dj.Imported
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_current_fig = [dir_base  '\Lick2D\Cells\PSTHGLM2\'];
            ...
            flag_plot_cells =0; %1 yes, 0 no
            % Spline basis
            SPLINE_PARAM.order = 2; %4
            SPLINE_PARAM.nInternalKnots = 3; %5
            
            self2=LICK2D.ROILick2DPSTHStatsSpikesGLM2;
