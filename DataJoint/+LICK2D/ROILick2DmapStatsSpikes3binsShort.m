...
classdef ROILick2DmapStatsSpikes3binsShort < dj.Computed
     properties
        keySource = EXP2.SessionEpoch & LICK2D.ROILick2DmapStatsSpikes3bins;
    end
    methods(Access=protected)
        function makeTuples(self, key)
        key_roi= fetch(LICK2D.ROILick2DmapStatsSpikes3bins & key, 'lickmap_regular_odd_vs_even_corr','psth_position_concat_regular_odd_even_corr','information_per_spike_regular','preferred_bin_regular','field_size_regular','field_size_without_baseline_regular');
        insert(self,key_roi)
        end
    end
end