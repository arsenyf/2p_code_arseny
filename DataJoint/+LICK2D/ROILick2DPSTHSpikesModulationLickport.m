...
classdef ROILick2DPSTHSpikesModulationLickport < dj.Computed
    properties
        ...
        keySource = (EXP2.SessionEpoch*IMG.FOV) & LICK2D.ROILick2DPSTHSpikesLickport  - IMG.Mesoscope;
        
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel1 = LICK2D.ROILick2DPSTHSpikesLickport & key;
