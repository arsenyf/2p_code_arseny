%{
# Alinged to Lickport Presentation
-> EXP2.SessionEpoch
-> IMG.ROI
---
...
classdef ROILick2DPSTHSpikesLickport < dj.Imported
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
           flag_electric_video = 1; %detect licks with electric contact or video (if available) 1 - electric, 2 - video
            ...
            %Also populates: 
            self2=LICK2D.ROILick2DPSTHStatsSpikesLickport;
           
           fn_computer_Lick2DPSTHLickport(key,self, rel_data,fr_interval, fr_interval_limit, flag_electric_video, time_resample_bin, self2);
