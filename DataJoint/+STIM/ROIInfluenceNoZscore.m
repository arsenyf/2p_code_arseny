%{
# ROI responses to each photostim group.  No Zscoring. DFF.
...
classdef ROIInfluenceNoZscore < dj.Computed
    properties
            ...
            for i_c = 1:1:numel(num_svd_components_removed_vector)
                ...
                parfor i_g = 1:1:numel(group_list) %parfor
                    ...
                    for i_r= 1:1:numel(roi_list)
                        ...
                        if isnan(StimStat.response_p_value1_odd)
                        ...
                        if isnan(StimStat.response_p_value1_even)
