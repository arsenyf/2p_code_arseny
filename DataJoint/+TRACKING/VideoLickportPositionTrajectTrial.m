...
-> EXP2.BehaviorTrial
---
lickport_x_traj  =null             : longblob                    # Medio-Lateral coordinate in mm, . Left negative, Right positive, relative to midline. Measured based on front/bottom camera
lickport_y1_traj      =null             : longblob                    # Anterior-Posterior coordinate in mm. Measured based on side camera relative to mouth
lickport_y2_traj      =null             : longblob                    # Anterior-Posterior coordinate  in mm. Measured based on front/bottom camera relative to mouth
lickport_z_traj       =null             : longblob                    # Dorso-Ventral coordinate in mm. Measured based on side camera relative to mouth
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            for ii =1:1:numel(trials)
                ...
                insert_key_lickport_position(ii).lickport_x_traj = LICKPORT_ML_Cam2;
                insert_key_lickport_position(ii).lickport_y1_traj = LICKPORT_AP_Cam1;
                insert_key_lickport_position(ii).lickport_y2_traj = LICKPORT_AP_Cam2;
                insert_key_lickport_position(ii).lickport_z_traj = LICKPORT_Z_Cam1;
            end
