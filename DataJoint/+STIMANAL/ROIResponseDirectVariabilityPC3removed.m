...
classdef ROIResponseDirectVariabilityPC3removed < dj.Imported
    properties
        %         keySource = IMG.PhotostimGroup;
        keySource = EXP2.SessionEpoch & 'flag_photostim_epoch =1' & (IMG.FOV & STIM.ROIInfluence2) & IMG.Volumetric & (IMG.ROIdeltaFPCremoved & 'num_svd_components_removed=3');
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i_g=1:1:numel(roi_list_direct)
                ...
                f_trace = fetch1(IMG.ROIdeltaFPCremoved & k1 & k_pc,'dff_trace');
