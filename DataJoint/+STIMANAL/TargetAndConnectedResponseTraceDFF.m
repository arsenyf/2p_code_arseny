...
classdef TargetAndConnectedResponseTraceDFF < dj.Computed
    properties
...
%                 timewind_response=[0.05,0.5];
            ...
            parfor i_g = 1:1:numel(group_list) %parfor
                ...
                rel_connected_cells=STIM.ROIInfluence2 & 'response_p_value1<=0.05' & sprintf('response_distance_lateral_um >%.2f', min_distance_to_closest_target) & sprintf('num_of_target_trials_used >%d', minimal_number_of_clean_trials) & k1;
