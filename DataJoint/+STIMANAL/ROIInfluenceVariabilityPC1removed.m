...
classdef ROIInfluenceVariabilityPC1removed < dj.Computed
    properties
        ...
        keySource = EXP2.SessionEpoch & STIMANAL.ROIResponseDirectVariabilityPC1removed &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1');
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i_g=1:1:numel(group_list)
                ...
                response_trials_direct = fetchn(STIMANAL.ROIResponseDirectVariabilityPC1removed & key & k_pc,'response_peak_trials');
                idx_photostim_trials_used_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC1removed & key & k_pc,'idx_photostim_trials_used')';
                ...
                response_trace_trials_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC1removed & k_pc & key,'response_trace_trials');
                time_vector_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC1removed & k_pc & key,'time_vector');
