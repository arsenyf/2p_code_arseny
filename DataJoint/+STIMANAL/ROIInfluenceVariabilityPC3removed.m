...
classdef ROIInfluenceVariabilityPC3removed < dj.Computed
    properties
        ...
        keySource = EXP2.SessionEpoch & STIMANAL.ROIResponseDirectVariabilityPC3removed &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1');
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_current_fig = [dir_base  '\Photostim\photostim_traces\coupled_analysis_for_ilan_paper_new_all_dff\'];
            ...
            k_pc.num_svd_components_removed=3;
            ...
            for i_g=1:1:numel(group_list)
                ...
                response_trials_direct = fetchn(STIMANAL.ROIResponseDirectVariabilityPC3removed & key & k_pc,'response_peak_trials');
                idx_photostim_trials_used_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC3removed & key & k_pc,'idx_photostim_trials_used')';
                ...
                response_trace_trials_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC3removed & k_pc & key,'response_trace_trials');
                time_vector_direct = fetch1(STIMANAL.ROIResponseDirectVariabilityPC3removed & k_pc & key,'time_vector');
                ...
                parfor i_r = 1:1:numel(signif_roi)
                    ...
                    try
                        f_trace_coupled= fetch1(IMG.ROIdeltaFPCremoved & k_pc & k2,'dff_trace');
                    catch
                        continue
                    end
