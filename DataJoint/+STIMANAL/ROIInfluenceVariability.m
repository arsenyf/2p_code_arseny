...
classdef ROIInfluenceVariability < dj.Computed
    properties
        ...
        keySource = EXP2.SessionEpoch & STIMANAL.ROIResponseDirectVariability&  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1');
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i_g=1:1:numel(group_list)
                ...
                idx_photostim_trials_used_direct = fetch1(STIMANAL.ROIResponseDirectVariability & key,'idx_photostim_trials_used')';
                ...
                parfor i_r = 1:1:numel(signif_roi)
                    ...
                    f_trace_coupled= fetch1(IMG.ROIdeltaF & k2,'dff_trace');
