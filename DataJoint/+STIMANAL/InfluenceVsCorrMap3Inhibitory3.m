...
classdef InfluenceVsCorrMap3Inhibitory3 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\inhibition3\single_sessions\tuning_by_map_stability\'];
