...
classdef ROIInfluenceVariabilitySpikesShort < dj.Computed
    properties
        ...
        keySource = EXP2.SessionEpoch & STIMANAL.ROIResponseDirectVariabilitySpikesShort;
...
%             min_distance_to_closest_target_pixels=min_distance_to_closest_target/pix2dist;
            ...
            rel=STIM.ROIInfluence2 & 'response_p_value1<=0.01' & sprintf('response_distance_lateral_um >%.2f', min_distance_to_closest_target) & 'response_mean>0';
...
%             position_y(end+1)=position_y(end) - vertical_distance;
            ...
            for i_g=1:1:numel(group_list)
                ...
                response_trials_direct = fetchn(STIMANAL.ROIResponseDirectVariabilitySpikesShort & key,'response_peak_trials');
                idx_photostim_trials_used_direct = fetch1(STIMANAL.ROIResponseDirectVariabilitySpikesShort & key ,'idx_photostim_trials_used')';
                ...
                response_trace_trials_direct = fetch1(STIMANAL.ROIResponseDirectVariabilitySpikesShort & key,'response_trace_trials');
                time_vector_direct = fetch1(STIMANAL.ROIResponseDirectVariabilitySpikesShort & key,'time_vector');
...
%                     title([sprintf('''Pre-synaptic''')]);
                    ...
                    f_trace_coupled = fetch1(IMG.ROISpikes & k2,'spikes_trace');
                    f_trace_coupled = zscore(f_trace_coupled);
