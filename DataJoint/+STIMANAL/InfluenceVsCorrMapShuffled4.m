...
classdef InfluenceVsCorrMapShuffled4 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_pval_signif = LICK2D.ROILick2DmapSpikes3binsPvalue2 & 'lickmap_fr_regular_modulation_pval<=0.05';
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirectUnique &  rel_target) &    (IMG.ROI &  (rel_pval_signif & k_psth));
                ...
                for i_p=1:1:numel(p_val)
                    ...
                    roi_psth_signif = fetchn(rel_data_signal & k_psth & rel_roi & rel_pval_signif, 'roi_number', 'ORDER BY roi_number');
