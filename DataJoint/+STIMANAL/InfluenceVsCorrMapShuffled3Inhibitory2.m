...
classdef InfluenceVsCorrMapShuffled3Inhibitory2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            maximal_distance=500; %um lateral;  exlude all cells further than maximal distance from target
...
%             bins_influence = [-inf, 0, 0.25, 0.5, 0.75, inf];
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\Inhibitory2\single_sessions\tuning_by_map_stability\'];
