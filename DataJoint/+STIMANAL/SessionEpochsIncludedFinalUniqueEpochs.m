...
classdef SessionEpochsIncludedFinalUniqueEpochs < dj.Lookup
    properties
        contents = {
...
%             462458 10 'spont_photo' 2  1  150   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
...
%             463195 4 'spont_photo' 1  1  150   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
%             463195 4 'spont_photo' 2  1  150  1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
            ...
            % weak photostimulation
%             464728 1 'spont_photo' 2  1  150   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
%             464728 2 'spont_photo' 2  1  150   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
...
%             486673 1 'spont_photo' 4  1  150   1 'target switches every 4 frames -- 1 time per volume'
            ...
            %
%             486668 2 'spont_photo' 2  1  100   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
...
%             496916 2 'spont_photo' 2  1  100   1 'target switches every 4 frames -- 1 time per volume '  very few target neurons
