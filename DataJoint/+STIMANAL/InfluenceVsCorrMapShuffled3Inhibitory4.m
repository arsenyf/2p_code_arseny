...
classdef InfluenceVsCorrMapShuffled3Inhibitory4 < dj.Computed
    properties
...
%             bins_influence = [-inf, 0, 0.25, 0.5, 0.75, inf];
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\Inhibitory4\single_sessions\tuning_by_map_stability\'];
