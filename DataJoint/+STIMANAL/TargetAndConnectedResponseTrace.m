...
classdef TargetAndConnectedResponseTrace < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & (STIMANAL.ROIResponseDirectUnique & 'response_p_value1<=0.05') &  (STIMANAL.SessionEpochsIncludedFinalUniqueEpochs & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1');
    end
