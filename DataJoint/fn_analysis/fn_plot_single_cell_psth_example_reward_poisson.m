function [psth_time] = fn_plot_single_cell_psth_example_reward_poisson (rel_example, roi_number_uid, xlabel_flag, ylabel_flag,panel_legend, cell_number, psth_max)
key_roi.roi_number_uid =roi_number_uid;
P =fetch(rel_example & key_roi,'*');

psth_time = P.psth_time_poisson;
...
psth_regular= P.psth_regular_poisson/psth_max;
psth_regular_stem= P.psth_regular_stem_poisson/psth_max;
psth_small= P.psth_small_poisson/psth_max;
psth_small_stem= P.psth_small_stem_poisson/psth_max;
psth_large= P.psth_large_poisson/psth_max;
psth_large_stem= P.psth_large_stem_poisson/psth_max;
hold on;
