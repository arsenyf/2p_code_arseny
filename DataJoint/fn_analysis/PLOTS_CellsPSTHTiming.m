function PLOTS_CellsPSTHTiming (key, dir_current_fig, flag_spikes, plot_one_in_x_cell , rel_rois)
close all;
...
if flag_spikes==0 % if based on dff
    ...
    rel_map_and_psth = LICK2D.ROILick2DPSTHSpikesLongerInterval  & rel_rois;
    rel_stats = LICK2D.ROILick2DPSTHStatsSpikesLongerInterval & rel_rois;
end
...
M.peaktime_psth_regular=[fetchn(rel_stats,'peaktime_psth_regular','ORDER BY roi_number')];
