function [psth_time] = fn_plot_single_cell_psth_example_reward_GLM (rel_example, roi_number_uid, xlabel_flag, ylabel_flag,panel_legend, cell_number, psth_max)
...
psth_regular= P.psth_regular_glm1/psth_max;
psth_regular_stem= P.psth_regular_stem__glm1/psth_max;
psth_small= P.psth_small__glm1/psth_max;
psth_small_stem= P.psth_small_stem__glm1/psth_max;
psth_large= P.psth_large__glm1/psth_max;
psth_large_stem= P.psth_large_stem__glm1/psth_max;
hold on;
