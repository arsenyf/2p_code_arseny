function   fn_compute_graph_and_connectivity_stats_min_out_degree_test(key, p_val_threshold,min_outdegree, minimal_distance,maximal_distance, dir_save_figure, self)
close
%Graphics
%---------------------------------
...
rel_out_degree = STIMANAL.OutDegree2 & key & 'p_val=0.05' & 'max_distance_lateral=1000' & sprintf('out_degree_excitatory>=%d',min_outdegree);
