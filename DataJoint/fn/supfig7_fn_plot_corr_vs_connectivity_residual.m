function supfig7_fn_plot_corr_vs_connectivity_residual(rel_data, rel_shuffled, key,colormap,   min_pairs_in_influence_bin, min_pairs_in_corr_bin, min_session_per_bin)
