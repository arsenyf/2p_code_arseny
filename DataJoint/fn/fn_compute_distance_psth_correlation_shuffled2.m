function fn_compute_distance_psth_correlation_shuffled2(rel_roi, rel_data, key,self, dir_save_fig, rel_roi_xy,mesoscope_flag)
...
for i_sh=1:1:num_shuffles
    [axial_distance_bins, distance_corr_2d_shuffled, distance_corr_lateral_shuffled, distance_corr_axial_columns_shuffled] ...
        = fn_correlation_vs_distance_shuffled2 (x_all,y_all,z_all, rho, lateral_distance_bins, min_distance_in_xy, column_inner_radius, column_outer_radius);
