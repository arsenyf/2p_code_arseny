function fn_compute_CorrPairwiseDistancePaper(key, rel_data, self, flag_zscore,time_bin, threshold_for_event_vector, dir_save_fig, num_svd_components_removed_vector)
