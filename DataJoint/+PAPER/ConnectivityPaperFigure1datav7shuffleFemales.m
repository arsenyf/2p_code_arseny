...
classdef ConnectivityPaperFigure1datav7shuffleFemales < dj.Computed
    properties
...
%             rel_positional_signif = rel_roi & (LICK2D.ROILick2DmapSpikes3binsPvalue & sprintf('lickmap_regular_odd_vs_even_corr_pval<=%.2f',p_value_threshold)); 
            ...
            rel_stats11= LICK2D.ROILick2DPSTHStatsSpikes*IMG.ROIID & rel_roi &  rel_temporal_signif;
            ...
            D_tuned_temporal.psth_regular_odd_vs_even_corr=fetchn(rel_stats11, 'psth_regular_odd_vs_even_corr','ORDER BY roi_number_uid');
