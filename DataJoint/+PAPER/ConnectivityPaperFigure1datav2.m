...
classdef ConnectivityPaperFigure1datav2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            filename=[sprintf('Figure1v2')];
            
            psth_regular_odd_vs_even_corr=0.25;
            information_per_spike_regular_threshold=0.02;
            ...
            % temporal only PSTHs
            rel_psth = LICK2D.ROILick2DPSTHSpikesLongerInterval*IMG.ROIID & rel_temporal_signif ;
            ...
            D_tuned_positional_4bins.number_of_fields_without_baseline_regular=fetchn(LICK2D.ROILick2DmapUnimodalitySpikes*IMG.ROIID & 'number_of_bins=4' & 'threshold_for_peak=0.25' & rel_positional_signif , 'number_of_fields_without_baseline_regular','ORDER BY roi_number_uid');
            
            PSTH_all = cell2mat(fetchn(rel_psth,'psth_regular','ORDER BY roi_number_uid'));
            
            psth_time = fetch1(rel_psth,'psth_time','LIMIT 1');
