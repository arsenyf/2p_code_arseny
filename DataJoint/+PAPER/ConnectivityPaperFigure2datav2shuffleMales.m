...
classdef ConnectivityPaperFigure2datav2shuffleMales < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_current_fig = [dir_base  'Connectivity_paper_figures\plots\males\'];
            
            filename=[sprintf('Figure2v4_males')];
            ...
            rel_roi=PAPER.ROILICK2DInclusion & (LAB.Subject & 'sex="M"');
