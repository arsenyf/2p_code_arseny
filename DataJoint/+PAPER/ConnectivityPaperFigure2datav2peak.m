...
classdef ConnectivityPaperFigure2datav2peak < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_reward_large_signif = rel_roi & (LICK2D.ROILick2DPSTHStatsSpikes & sprintf('reward_peak_pval_regular_large<=%.2f',reward_p_value_threshold));
            rel_reward_small_signif = rel_roi & (LICK2D.ROILick2DPSTHStatsSpikes & sprintf('reward_peak_pval_regular_small<=%.2f',reward_p_value_threshold));
            ...
            rel_positional_and_allreward_signif = rel_roi & (LICK2D.ROILick2DmapStatsSpikes3binsShort & sprintf('lickmap_regular_odd_vs_even_corr>=%.2f',lickmap_regular_odd_vs_even_corr_threshold)) & (rel_reward_large_signif | rel_reward_small_signif);
