function [StimStat, StimTrace] = fn_compute_photostim_delta_influence5_single_trials (f_trace, photostim_start_frame,baseline_start_frame, timewind_response,time)
