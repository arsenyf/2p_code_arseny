function PLOT_Network_Degree_vs_tuning_similarity_to_connected_neurons_f()
% clf

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  'Connectivity_paper_figures\plots\revision\males_females\'];
filename = 'Fig4_panel_OutDegree_vs_tuning_similarity_to_connected_neurons_females';
num_shuffles=100;
rel_include= (IMG.ROI- IMG.ROIBad) & STIM.ROIResponseDirectUnique & (LAB.Subject & 'sex="F"');
...
rel_session = EXP2.Session & (STIMANAL.OutDegree & IMG.Volumetric) & (EXP2.SessionEpoch& 'session_epoch_type="spont_only"')...
    ...
    & (LICK2D.ROILick2DmapStatsSpikes3binsShort) & (rel_sex & 'sex="F"');
...
for i_s = 1:1:rel_session.count
    ...
    rel_signal1 = STIMANAL.Target2ConnectedCorrTuningMap2 & k_s & k_tuning_corr & rel_include  & (STIMANAL.NeuronOrControl & k_neurons_or_control);
